<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AddCampActivity.aspx.cs" Inherits="Campsite_Management.CampActivity.AddCampActivity" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <br />
 <br />
 <h1 style="color: #15c269; font-family: 'Brush Script MT', cursive; font-size: 60px; text-align: center;">Add New Camp Activity</h1>
 <br />
 <br />
