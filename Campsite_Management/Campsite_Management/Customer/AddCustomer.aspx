<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AddCustomer.aspx.cs" Inherits="Campsite_Management.Customer.AddCustomer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br>
<br>
<h1 style="color: #15c269; font-family: 'Brush Script MT', cursive; font-size: 60px; text-align: center;">Add New Customer Record</h1>
<br>
<br>
   <div class="container">
       <form runat="server">
